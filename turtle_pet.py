...
def _parse_args(args):
    ...
    # training
    parser.add_argument('--gamma', type=float, default=250.0, help='Hyperparameter for entropy regularization in Eq. (12)')
    parser.add_argument('--power', type=float, default=0.01, help='Hyperparameter for Power Law Distribution')
