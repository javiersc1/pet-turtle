...
trainFeatures = np.load("data/representations/clipRN50x64/food101_train.npy")
valFeatures = np.load("data/representations/clipRN50x64/food101_val.npy")
trainLabels = np.load("data/labels/food101_train.npy")
valLabels = np.load("data/labels/food101_val.npy")
...
np.save("data/representations/clipRN50x64/food101lt_train.npy", trainFeaturesLT)
np.save("data/representations/clipRN50x64/food101lt_val.npy", valFeaturesLT)
np.save("data/labels/food101lt_train.npy", trainLabelsLT)
np.save("data/labels/food101lt_val.npy", valLabelsLT)
np.save("dataset_preparation/food101lt_distribution.npy", distribution)
